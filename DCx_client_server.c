...
-- DCx_client_server.c
--
-- IMPORTANT NOTE: Actually a #include in DCx.c for the main code to be server
--
-- server and client side code to execute high level remote control of the 
-- imaging.  Primarily meant to provide control by CHESS routines to analyze
-- stripes in the SARA MURI project.
--
-- This code is primarily for the client side ... for the server, IS_SERVER
-- is #defined and is included from the dcx.c.  Since the client and server 
-- code has to be linked, both are here.
******************************************************************************/
...
/* ===========================================================================
-- The client and server side codes are below.  Both integrated in one
=========================================================================== */


/* =========================================================================== */
/* =========================================================================== */
#ifndef IS_DCX_SERVER			/* Client side code */
/* =========================================================================== */
/* =========================================================================== */
...
/* =========================================================================== */
/* =========================================================================== */
#else									/* Server side code (IS_DCx_SERVER) */
/* =========================================================================== */
/* =========================================================================== */
...
#ifdef DUMMY_FAKE_CAMERA
	int DCx_Status(DCX_STATUS *status) {
		strcpy(status->manufacturer, "Manufacturer: Thorlabs GmbH");
		strcpy(status->model,   "C1284R13C");
		strcpy(status->serial,  "Serial: 4103534309");
		strcpy(status->version, "Version: V1.0");
		strcpy(status->date,    "Date: 22.05.2019");
		status->CameraID = 1;
